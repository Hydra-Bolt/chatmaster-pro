...
def getGoogleAgent(model='gpt-3.5-turbo'):
    ...
    TEMPLATE = '''Answer the following questions as best you can, be as descriptive as possible, Always use markdown to enhance your answer, current_date = {date}. You have access to the following tool:
    {tools}
    ...
    prompt = PromptTemplate.from_template(template=TEMPLATE, partial_variables={"date": datetime.now()},)
    # Create the agent
